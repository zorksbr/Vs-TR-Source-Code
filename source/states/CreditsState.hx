...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var bgList:Array<String> = ['menubg/zorks', 'menubg/tr', 'menubg/blood', 'menubg/tales', 'menubg/henriqueower'];

		// Escolhe um background aleatório
		var chosenBG:String = bgList[FlxG.random.int(0, bgList.length - 1)];

		// Cria o sprite do background
		bg = new FlxSprite().loadGraphic(Paths.image(chosenBG));
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			["HenriqueOwer",		"henriquecred",		"Artista",										"https://youtube.com/@Henrique0we3r",			"6D0FA3"],
			[""],
			["Inspirado em:"],
			["Vs. Dave and Bambi",	"dnbcred",			"Inspiração",									"https://gamebanana.com/mods/43201", 			"0DD97A"],
			[""],
			["Psych Engine Team"],
