...
local songData = { -- The main table that contains the songs you want credits on
    ...
    ['starting-now'] = { -- This name NEEDS to be the name in the direct JSON/chart (e.g: dad-battle).
        ["songName"] = "Starting Now", -- The display name of the song.
        ["length"] = 3, -- The length the box is on screen.
        ["boxColor"] = "#000000", -- Color of Box (IN HEX).
        ["textColor"] = "#FFFFFF", -- Color of Text (IN HEX).
        ["credits"] = { "Composer", "Artist", "Charter",-- Include whatever roles you want here, the order WILL NOT be however you order them here.
    ...
    ['realization'] = { 
        ["songName"] = "Realization", 
        ["length"] = 3, 
        ["boxColor"] = "#000000", 
        ["textColor"] = "#FFFFFF", 
        ["credits"] = { "Composer", "Artist", "Charter",
            ["Composer"] = "ZorksBR",
            ["Artist"] = "TR, ZorksBR",
            ["Charter"] = "ZorksBR",
        },
    ...
    ['data-removed'] = { 
        ["songName"] = "DATA-REMOVED", 
        ["length"] = 5, 
        ["boxColor"] = "#000000", 
        ["textColor"] = "#FFFFFF", 
        ["credits"] = { "Lord", "Composer", "Artist", "Charter",
            ["LORD"] = "RT",
            ["Composer"] = "ZorksBR",
            ["Artist"] = "ZorksBR",
            ["Charter"] = "ZorksBR",
...
function createBox(songTable) -- Creates the main box container
    if songTable then
        ...
        --setObjectCamera('creditContainer', 'hud')
        setProperty('creditContainer.camera', instanceArg('camOther'), true, true)
...
function createTitle(songTable) -- Creates the song title
    ...
    if songTable then
        ...
        if not options["noCredits"] then
            ...
            setProperty('songTitle.camera', instanceArg('camOther'), true, true)
    ...
    if songTableMAIN then
        ...
        if not options["noCredits"] then
            ...
            for i, v in pairs(creditTable) do
                ...
                setProperty(labelName..'.camera', instanceArg('camOther'), true, true)
            ...
            setProperty('songPlaying.camera', instanceArg('camOther'), true, true)
